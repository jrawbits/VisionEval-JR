...
ve.stage.init <- function(Name=NULL,Model=NULL,stageParam_ls=list(),stageConfig_ls=list()) {
  ...
  if ( is.null(Model) || ! "VEModel" %in% class(Model) ) {
    stop("No Model provided for model stage ",Name)
