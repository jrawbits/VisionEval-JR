...
scr.m <- tkscrollbar(tt, repeatinterval=4,command=function(...) tkyview(t.m,...))
scr.s <- tkscrollbar(tt, repeatinterval=4,command=function(...) tkyview(t.s,...))
scr.a <- tkscrollbar(tt, repeatinterval=4,command=function(...) tkyview(t.a,...))
