...
get_two_inputs <- function() {
  ...
  # First input
  tkgrid(tklabel(tt, text = "Value 1:"), column = 0, row = 0, sticky = "w", padx = 5, pady = 5)
  value1_var <- tclVar("")
  value1_entry <- tkentry(tt, textvariable = value1_var)
  tkgrid(value1_entry, column = 1, row = 0, sticky = "we", padx = 5, pady = 5)

  # Second input
  tkgrid(tklabel(tt, text = "Value 2:"), column = 0, row = 1, sticky = "w", padx = 5, pady = 5)
  value2_var <- tclVar("")
  value2_entry <- tkentry(tt, textvariable = value2_var)
